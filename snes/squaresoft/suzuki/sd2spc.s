...
020d: e8 00     mov   a,#$00
020f: 8d 0c     mov   y,#$0c
0211: 3f 1b 06  call  $061b
0214: 8d 1c     mov   y,#$1c
0216: 3f 1b 06  call  $061b
0219: 8d 2c     mov   y,#$2c
021b: 3f 1b 06  call  $061b
021e: 8d 3c     mov   y,#$3c
0220: 3f 1b 06  call  $061b
0223: 8d 2d     mov   y,#$2d
0225: 3f 1b 06  call  $061b
0228: 8d 3d     mov   y,#$3d
022a: 3f 1b 06  call  $061b
022d: 8d 4d     mov   y,#$4d
022f: 3f 1b 06  call  $061b
0232: 8d 5d     mov   y,#$5d
0234: e8 19     mov   a,#$19
0236: 3f 1b 06  call  $061b
0239: 8d 07     mov   y,#$07
023b: cd a0     mov   x,#$a0
023d: cb f2     mov   $f2,y
023f: d8 f3     mov   $f3,x
...
0245: fd        mov   y,a
0246: 10 f5     bpl   $023d
0248: 8f f0 f1  mov   $f1,#$f0
024b: 8f 24 fa  mov   $fa,#$24
024e: 8f 01 f1  mov   $f1,#$01
0251: 8f 02 df  mov   $df,#$02
0254: 3f de 12  call  $12de
0257: 3f 2f 13  call  $132f
025a: e8 7f     mov   a,#$7f
025c: 8d 0c     mov   y,#$0c
025e: 3f 1b 06  call  $061b
0261: 8d 1c     mov   y,#$1c
0263: 3f 1b 06  call  $061b
0266: 8f ff b0  mov   $b0,#$ff
0269: 8f 07 dd  mov   $dd,#$07
026c: e2 90     set7  $90
026e: e2 9c     set7  $9c
0270: 8d 08     mov   y,#$08
0272: e8 ff     mov   a,#$ff
0274: d6 7f ff  mov   $ff7f+y,a
0277: fe fb     dbnz  y,$0274
0279: 3f af 0c  call  $0caf
027c: eb fd     mov   y,$fd
027e: f0 f9     beq   $0279
0280: 8d 06     mov   y,#$06
...
031e: fa ad 02  mov   ($02),($ad)
0321: 4b 02     lsr   $02
0323: 90 30     bcc   $0355
0325: d8 05     mov   $05,x
0327: 9b 3c     dec   $3c+x
0329: d0 05     bne   $0330
032b: 3f b1 03  call  $03b1
032e: 2f 21     bra   $0351
0330: e4 ae     mov   a,$ae
0332: 24 b2     and   a,$b2
0334: d0 1f     bne   $0355
...
03b1: 3f 62 05  call  $0562             ; read vcmd
03b4: 68 d2     cmp   a,#$d2
03b6: 90 05     bcc   $03bd
03b8: 3f 4e 05  call  $054e
03bb: 2f f4     bra   $03b1
03bd: 8d 00     mov   y,#$00
03bf: cd 0f     mov   x,#$0f
03c1: 9e        div   ya,x
03c2: f8 05     mov   x,$05
03c4: f6 2c 15  mov   a,$152c+y
03c7: d4 3c     mov   $3c+x,a
03c9: 3f 6d 05  call  $056d
03cc: 78 b4 04  cmp   $04,#$b4
03cf: 90 09     bcc   $03da
03d1: 78 c3 04  cmp   $04,#$c3
03d4: b0 03     bcs   $03d9
03d6: 5f 85 04  jmp   $0485
...
03eb: c4 04     mov   $04,a
03ed: f8 05     mov   x,$05
03ef: f4 3d     mov   a,$3d+x
03f1: 8d 0c     mov   y,#$0c
03f3: cf        mul   ya
03f4: 60        clrc
03f5: 84 04     adc   a,$04
03f7: 60        clrc
03f8: 95 61 fd  adc   a,$fd61+x
03fb: 80        setc
03fc: a8 0a     sbc   a,#$0a
03fe: d5 41 fd  mov   $fd41+x,a
0401: 3f ed 04  call  $04ed
0404: e4 08     mov   a,$08
0406: d5 60 fe  mov   $fe60+x,a
0409: e4 09     mov   a,$09
040b: d5 61 fe  mov   $fe61+x,a
040e: 8d 07     mov   y,#$07
...
; vcmd e5 - increase octave
07c0: f5 3d 00  mov   a,$003d+x
07c3: bc        inc   a
07c4: 2f 04     bra   $07ca
; vcmd e6 - decrease octave
...
0879: d5 80 fe  mov   $fe80+x,a
087c: f6 81 18  mov   a,$1881+y
087f: d5 81 fe  mov   $fe81+x,a
0882: 6f        ret
...
08b4: 3f 1b 06  call  $061b
08b7: fc        inc   y
08b8: f5 81 fe  mov   a,$fe81+x
08bb: 5f 1b 06  jmp   $061b

; vcmd ec - ADSR decay rate
08be: 28 07     and   a,#$07
08c0: 9f        xcn   a
08c1: c4 04     mov   $04,a
...
; vcmd ef - default ADSR
08f3: f4 5d     mov   a,$5d+x
08f5: 1c        asl   a
08f6: fd        mov   y,a
08f7: f6 80 18  mov   a,$1880+y
08fa: d5 80 fe  mov   $fe80+x,a
08fd: f6 81 18  mov   a,$1881+y
0900: d5 81 fe  mov   $fe81+x,a
0903: 2f 9b     bra   $08a0
...
090d: dd        mov   a,y
090e: eb 04     mov   y,$04
0910: 7a 06     addw  ya,$06
0912: d4 0c     mov   $0c+x,a
0914: db 0d     mov   $0d+x,y
0916: 6f        ret

; vcmd f9 - conditional goto #1
0917: c4 36     mov   $36,a
...
; vcmd fc - reset conditional goto counter
093a: c8 10     cmp   x,#$10
093c: b0 05     bcs   $0943
093e: e8 00     mov   a,#$00
...
; vcmd fd - ignore master volume
09b4: c8 10     cmp   x,#$10
09b6: b0 03     bcs   $09bb
09b8: c5 88 ff  mov   $ff88,a
09bb: 6f        ret

; vcmd f2,fe-ff - end of track
09bc: ae        pop   a
09bd: ae        pop   a
09be: e4 b2     mov   a,$b2
09c0: c8 10     cmp   x,#$10
...
0cf8: 8f 00 f1  mov   $f1,#$00
0cfb: 8f 40 fa  mov   $fa,#$40
0cfe: 8f 01 f1  mov   $f1,#$01
0d01: e4 fd     mov   a,$fd
0d03: e4 fd     mov   a,$fd
0d05: f0 fc     beq   $0d03
0d07: 8f 00 f1  mov   $f1,#$00
0d0a: 8f 24 fa  mov   $fa,#$24
0d0d: 8f 01 f1  mov   $f1,#$01
0d10: f8 f4     mov   x,$f4
0d12: e4 f6     mov   a,$f6
0d14: 28 0f     and   a,#$0f
0d16: c4 df     mov   $df,a
...
0e24: da 2c     movw  $2c,ya            ; $2c00 + (byte_b5 * 4)
0e26: cd 00     mov   x,#$00
0e28: 8d 01     mov   y,#$01
...
0f6b: db 0d     mov   $0d+x,y           ; read voice ptr from header
...
12e7: e8 00     mov   a,#$00
12e9: 8d 4d     mov   y,#$4d
12eb: 3f 1b 06  call  $061b
12ee: 8d 0d     mov   y,#$0d
12f0: 3f 1b 06  call  $061b
12f3: 8d 2c     mov   y,#$2c
12f5: 3f 1b 06  call  $061b
12f8: 8d 3c     mov   y,#$3c
12fa: 3f 1b 06  call  $061b
12fd: 8d 7d     mov   y,#$7d
12ff: cb f2     mov   $f2,y
1301: e4 f3     mov   a,$f3
1303: 28 0f     and   a,#$0f
...
1317: 88 fa     adc   a,#$fa
1319: 8d 6d     mov   y,#$6d
131b: 3f 1b 06  call  $061b
131e: c4 e2     mov   $e2,a
1320: 8f 00 e1  mov   $e1,#$00
1323: 8f 01 f1  mov   $f1,#$01
1326: 8f 80 fb  mov   $fb,#$80
1329: 8f 03 f1  mov   $f1,#$03
132c: e4 fe     mov   a,$fe
132e: 6f        ret
...
1361: e4 a7     mov   a,$a7
1363: 8d 2c     mov   y,#$2c
1365: 3f 1b 06  call  $061b
1368: 8d 3c     mov   y,#$3c
136a: 3f 1b 06  call  $061b
...
; vcmd dispatch table
1428: dw $0668  ; d2 - volume
142a: dw $0674  ; d3 - volume fade
142c: dw $06b4  ; d4 - pan
142e: dw $06e4  ; d5 - pan fade
1430: dw $0720  ; d6 - portamento
1432: dw $0737  ; d7 - vibrato
1434: dw $0749  ; d8 - vibrato off
1436: dw $074d  ; d9 - tremolo
1438: dw $075f  ; da - tremolo off
143a: dw $0763  ; db - pan LFO
143c: dw $07b4  ; dc - pan LFO off
143e: dw $0831  ; dd - noise frequency
1440: dw $07f5  ; de - noise on
1442: dw $081d  ; df - noise off
1444: dw $083f  ; e0 - pitchmod on
1446: dw $0856  ; e1 - pitchmod off
1448: dw $07ce  ; e2 - echo on
144a: dw $07e5  ; e3 - echo off
144c: dw $07ca  ; e4 - set octave
144e: dw $07c0  ; e5 - increase octave
1450: dw $07c6  ; e6 - decrease octave
1452: dw $072f  ; e7 - transpose (absolute)
1454: dw $072b  ; e8 - transpose (relative)
1456: dw $09b0  ; e9 - tuning
1458: dw $0866  ; ea - instrument
145a: dw $0890  ; eb - ADSR attack rate
145c: dw $08be  ; ec - ADSR decay rate
145e: dw $08d1  ; ed - ADSR sustain level
1460: dw $08e3  ; ee - ADSR sustain rate
1462: dw $08f3  ; ef - default ADSR
1464: dw $0944  ; f0 - repeat start
1466: dw $096b  ; f1 - repeat end
1468: dw $09bc  ; f2 - end of track
146a: dw $0620  ; f3 - tempo
146c: dw $062d  ; f4 - tempo fade
146e: dw $06b3  ; f5 - nop
1470: dw $06b0  ; f6 - nop.1
1472: dw $0733  ; f7 - nop.1
1474: dw $0665  ; f8 - master volume
1476: dw $0917  ; f9 - conditional goto #1
1478: dw $0905  ; fa - goto
147a: dw $0995  ; fb - conditional goto #2
147c: dw $093a  ; fc - reset conditional goto counter
147e: dw $09b4  ; fd - ignore master volume
1480: dw $09bc  ; fe - end of track (duplicated)
1482: dw $09bc  ; ff - end of track (duplicated)

; vcmd length table
1484: db         $01,$02,$01,$02,$02,$03
148a: db $00,$03,$00,$02,$00,$01,$00,$00
1492: db $00,$00,$00,$00,$01,$00,$00,$01
149a: db $01,$01,$01,$01,$01,$01,$01,$00
14a2: db $01,$00,$00,$01,$02,$01,$02,$02
14aa: db $01,$03,$02,$02,$00,$01,$00,$00

; cpu cmd dispatch table (80-8f, f0-ff)
14b2: dw $1011  ; 80
14b4: dw $12dd  ; 81 - nop
14b6: dw $12dd  ; 82 - nop
14b8: dw $100f  ; 83
