...
0698: 30 23     bmi   $06bd
069a: d4 a4     mov   $a4+x,a   ; set note length
069c: 3f 66 0a  call  $0a66
069f: 30 1c     bmi   $06bd
06a1: e7 82     mov   a,($82+x)
06a3: 68 c8     cmp   a,#$c8	; tie
06a5: 90 08     bcc   $06af
...
06bd: 68 ff     cmp   a,#$ff	; end of track
06bf: d0 39     bne   $06fa
06c1: e8 00     mov   a,#$00
...
077a: 2d        push  a
077b: f6 c0 06  mov   a,$06c0+y
077e: 2d        push  a
077f: 6f        ret

; vcmd dispatch table
0780: dw $07b8 ; e0 - set instrument
0782: dw $080f ; e1 - master volume
0784: dw $081f ; e2 - volume
0786: dw $081f ; e3 - volume
0788: dw $082f ; e4 - nop
078a: dw $0830 ; e5 - pan
078c: dw $083f ; e6 - pan fade
078e: dw $085e ; e7 - tremolo on
0790: dw $0871 ; e8 - tremolo off
0792: dw $0877 ; e9 - global transpose
0794: dw $087e ; ea - per-voice transpose
0796: dw $0885 ; eb
0798: dw $088c ; ec - tuning
079a: dw $08aa ; ed - vibrato on
079c: dw $08c0 ; ee - vibrato off
079e: dw $08c6 ; ef - pitch slide
07a0: dw $08e7 ; f0 - nop
07a2: dw $08e7 ; f1 - nop
07a4: dw $08e7 ; f2 - nop
07a6: dw $08e8 ; f3 - echo vbits/volume
07a8: dw $090e ; f4 - disable echo
07aa: dw $0917 ; f5 - set echo params
07ac: dw $09aa ; f6 - nop
07ae: dw $09ab ; f7 - tempo
07b0: dw $09bd ; f8 - tempo fade
07b2: dw $09e7 ; f9 - call subroutine
07b4: dw $0a12 ; fa - set perc patch base
07b6: dw $0a1c ; fb
...
0943: db $58,$bf,$db,$f0,$fe,$07,$0c,$0c
094c: db $0c,$21,$2b,$2b,$13,$fe,$f3,$f9
0953: db $34,$33,$00,$d9,$e5,$01,$fc,$eb
...
0fea: db $0c,$1c,$4c,$5c,$2d,$3d,$6c,$2c
0ff2: db $3c,$0d,$4d,$5d,$0f,$1f,$2f,$3f
0ffa: db $4f,$5f,$6f,$7f
...
102a: db $60,$60,$00,$00,$00,$00,$20,$00
1032: db $00,$00,$00,$3c,$7f,$00,$00,$00
103a: db $00,$00,$00,$00
