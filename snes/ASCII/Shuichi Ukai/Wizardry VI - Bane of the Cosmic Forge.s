...
04a9: db $80,$80,$7f,$7f,$7d,$7c,$7a,$78
...
0864: 5f 13 0c  jmp   $0c13

; vcmd f5
0867: 90 06     bcc   $086f
0869: 29 8f aa  and   ($aa),($8f)
086c: 5f 15 0c  jmp   $0c15
...
0895: 5f 15 0c  jmp   $0c15

0898: fd        mov   y,a
0899: f6 36 04  mov   a,$0436+y
089c: c4 ba     mov   $ba,a
089e: f6 e4 03  mov   a,$03e4+y
08a1: c4 bb     mov   $bb,a
08a3: eb ab     mov   y,$ab
08a5: 60        clrc
...
0994: dd        mov   a,y
0995: 60        clrc
0996: 95 24 02  adc   a,$0224+x
0999: d5 24 02  mov   $0224+x,a
099c: 5f 13 0c  jmp   $0c13

; vcmd e2
099f: f8 ab     mov   x,$ab
09a1: dd        mov   a,y
09a2: d5 3c 02  mov   $023c+x,a
09a5: 5f 13 0c  jmp   $0c13

; vcmd e4
09a8: 38 fd 9d  and   $9d,#$fd
09ab: f8 ab     mov   x,$ab
09ad: dd        mov   a,y
09ae: d5 48 02  mov   $0248+x,a
09b1: b0 05     bcs   $09b8
09b3: e4 90     mov   a,$90
09b5: 3f c3 09  call  $09c3
09b8: 5f 13 0c  jmp   $0c13

; vcmd f9
09bb: 18 02 9d  or    $9d,#$02
09be: cb 92     mov   $92,y
09c0: 5f 13 0c  jmp   $0c13
...
09e3: 5f 13 0c  jmp   $0c13

; vcmd fa
09e6: cc f6 00  mov   $00f6,y
09e9: 5f 13 0c  jmp   $0c13

; vcmd e6
09ec: f8 ab     mov   x,$ab
09ee: 38 d7 9d  and   $9d,#$d7
09f1: 3f b9 0a  call  $0ab9             ; read arg (2 bytes)
09f4: 40        setp
09f5: c6        mov   (x),a
09f6: db 0c     mov   $0c+x,y
09f8: 20        clrp
09f9: 5f 13 0c  jmp   $0c13
...
0a1b: 20        clrp
0a1c: 5f 13 0c  jmp   $0c13

; vcmd e9
0a1f: f8 ab     mov   x,$ab
0a21: b0 04     bcs   $0a27
0a23: dd        mov   a,y
0a24: d5 3c 01  mov   $013c+x,a
0a27: 5f 13 0c  jmp   $0c13
...
0a36: c4 b8     mov   $b8,a
0a38: 3f b9 0a  call  $0ab9             ; read arg (2 bytes)
0a3b: 60        clrc
0a3c: 84 b8     adc   a,$b8
...
0a68: 3f b9 0a  call  $0ab9             ; read arg (2 bytes)
0a6b: c4 b8     mov   $b8,a
0a6d: dd        mov   a,y
...
0a76: 3a 8c     incw  $8c
0a78: 3f b9 0a  call  $0ab9             ; read arg (2 bytes)
0a7b: 40        setp
0a7c: d4 18     mov   $18+x,a
0a7e: db 24     mov   $24+x,y
0a80: 20        clrp
0a81: 5f 13 0c  jmp   $0c13
...
0b67: 20        clrp
0b68: 5f 15 0c  jmp   $0c15

; vcmd d9 - (contidional jump?)
0b6b: cd 9a     mov   x,#$9a
...
0ba1: 26        and   a,(x)
0ba2: c6        mov   (x),a
0ba3: 5f 15 0c  jmp   $0c15

; vcmd d8 - (contidional jump?)
0ba6: f8 ab     mov   x,$ab
0ba8: 3a 8c     incw  $8c
0baa: 40        setp
0bab: cb 79     mov   $79,y
...
0c22: 80        setc
0c23: a8 ac     sbc   a,#$ac
0c25: 10 0b     bpl   $0c32             ; branch if $00-d3
0c27: 60        clrc
0c28: 88 2c     adc   a,#$2c            ; $d4-ff => $00-2b
0c2a: 1c        asl   a
0c2b: 5d        mov   x,a
...
0c40: 3f b9 0a  call  $0ab9             ; read arg (2 bytes)
0c43: ad ff     cmp   y,#$ff
0c45: d0 06     bne   $0c4d
0c47: 18 04 9d  or    $9d,#$04          ; set bit 2
0c4a: 3f b9 0a  call  $0ab9             ; read arg (2 bytes)
0c4d: ad 8f     cmp   y,#$8f
0c4f: f0 10     beq   $0c61
...
0ca4: f8 ac     mov   x,$ac
0ca6: e4 b3     mov   a,$b3
0ca8: d5 dc 03  mov   $03dc+x,a
0cab: 3f 98 08  call  $0898
0cae: da 94     movw  $94,ya
0cb0: ee        pop   y
0cb1: dd        mov   a,y
0cb2: 30 39     bmi   $0ced
0cb4: da 90     movw  $90,ya
0cb6: f8 ab     mov   x,$ab
0cb8: 23 9d 0b  bbs1  $9d,$0cc6
0cbb: f5 48 02  mov   a,$0248+x
0cbe: cf        mul   ya
0cbf: dd        mov   a,y
0cc0: d0 02     bne   $0cc4
0cc2: e4 90     mov   a,$90
...
0d18: 5f 6c 0d  jmp   $0d6c

0d1b: 3a 8c     incw  $8c
; vcmd e3
0d1d: f8 ac     mov   x,$ac
0d1f: 09 8e a5  or    ($a5),($8e)
0d22: 3f b9 0a  call  $0ab9             ; read arg (2 bytes)
0d25: d5 b0 02  mov   $02b0+x,a
0d28: 3f b9 0a  call  $0ab9             ; read arg (2 bytes)
...
; increase voice pointer, then write it back to array
0d6a: 3a 8c     incw  $8c
...
; vcmd ee
0d95: cc 9a 01  mov   $019a,y
0d98: 3f b9 0a  call  $0ab9             ; read arg (2 bytes)
0d9b: cc 9b 01  mov   $019b,y
0d9e: 5f 13 0c  jmp   $0c13

; vcmd ef
0da1: 8f 00 a3  mov   $a3,#$00
0da4: 6d        push  y
0da5: 3f 76 0d  call  $0d76
0da8: 8f 01 9c  mov   $9c,#$01
0dab: 18 80 a0  or    $a0,#$80
0dae: 3a 8c     incw  $8c
0db0: ae        pop   a
0db1: 8d 7d     mov   y,#$7d
0db3: 3f 20 08  call  $0820             ; set EDL
0db6: 3f b9 0a  call  $0ab9             ; read arg (2 bytes)
0db9: 8d 0d     mov   y,#$0d
0dbb: 3f 20 08  call  $0820             ; set EFB
0dbe: 3f 52 11  call  $1152
0dc1: cd 07     mov   x,#$07
...
0e3d: 5f 13 0c  jmp   $0c13

; vcmd f2
0e40: 38 ef 9d  and   $9d,#$ef
0e43: 5f 15 0c  jmp   $0c15

; vcmd da - push address
0e46: f8 ab     mov   x,$ab
0e48: 40        setp
0e49: fb 60     mov   y,$60+x
0e4b: bb 60     inc   $60+x             ; increase the stack offset
0e4d: 20        clrp
0e4e: e4 8c     mov   a,$8c
0e50: 60        clrc
0e51: 88 02     adc   a,#$02
...
0e5d: 3f b9 0a  call  $0ab9             ; read arg (2 bytes)
0e60: 5f 0e 0c  jmp   $0c0e

; vcmd db - pop address
0e63: f8 ab     mov   x,$ab
0e65: 40        setp
0e66: 9b 60     dec   $60+x             ; decrease the stack offset
...
; cpucmd e6 - song select
0e88: fd        mov   y,a               ; song number
0e89: f6 00 2e  mov   a,$2e00+y         ; song address table (low-byte)
0e8c: c4 b8     mov   $b8,a
0e8e: f6 80 2e  mov   a,$2e80+y         ; song address table (high-byte)
0e91: c4 b9     mov   $b9,a
0e93: cd 00     mov   x,#$00
0e95: e7 b8     mov   a,($b8+x)         ; (song header) offset 0
0e97: c4 ba     mov   $ba,a
0e99: 1c        asl   a
0e9a: c4 bb     mov   $bb,a
...
0ec6: 5d        mov   x,a
0ec7: eb ba     mov   y,$ba
0ec9: f7 b8     mov   a,($b8)+y         ; voice pointer (low)
0ecb: d5 00 02  mov   $0200+x,a
0ece: eb bb     mov   y,$bb
0ed0: f7 b8     mov   a,($b8)+y         ; voice pointer (high)
...
0f38: 40        setp
0f39: f4 89     mov   a,$89+x
0f3b: d4 48     mov   $48+x,a
0f3d: d4 54     mov   $54+x,a
0f3f: d4 60     mov   $60+x,a
0f41: 20        clrp
0f42: 6f        ret
...
0f90: 3f 76 0d  call  $0d76
0f93: cd 07     mov   x,#$07
0f95: e8 05     mov   a,#$05
0f97: 3f 23 0f  call  $0f23
0f9a: f5 00 12  mov   a,$1200+x
0f9d: d5 00 02  mov   $0200+x,a
0fa0: f5 08 12  mov   a,$1208+x
...
0fd5: 18 02 9f  or    $9f,#$02
0fd8: 38 fe 9f  and   $9f,#$fe
...
; cpucmd ff
1054: 8f 7f f4  mov   $f4,#$7f
1057: 78 7f f4  cmp   $f4,#$7f
105a: d0 fb     bne   $1057
105c: fa f6 dd  mov   ($dd),($f6)
105f: fa f7 de  mov   ($de),($f7)
1062: 8f 80 f4  mov   $f4,#$80
1065: 78 80 f4  cmp   $f4,#$80
1068: d0 fb     bne   $1065
106a: fa f6 df  mov   ($df),($f6)
106d: fa f7 e0  mov   ($e0),($f7)
1070: 8f 7f f4  mov   $f4,#$7f
1073: cd 00     mov   x,#$00
1075: e4 f4     mov   a,$f4
1077: 30 fc     bmi   $1075
1079: e4 f5     mov   a,$f5
107b: c7 dd     mov   ($dd+x),a
107d: ba f6     movw  ya,$f6
107f: 8f 80 f4  mov   $f4,#$80
1082: 1a df     decw  $df
1084: f0 41     beq   $10c7
1086: 3a dd     incw  $dd
1088: c7 dd     mov   ($dd+x),a
108a: 1a df     decw  $df
108c: f0 39     beq   $10c7
108e: 3a dd     incw  $dd
1090: dd        mov   a,y
1091: c7 dd     mov   ($dd+x),a
1093: 1a df     decw  $df
1095: f0 30     beq   $10c7
1097: 3a dd     incw  $dd
1099: e4 f4     mov   a,$f4
109b: 10 fc     bpl   $1099
109d: e4 f5     mov   a,$f5
109f: c7 dd     mov   ($dd+x),a
10a1: ba f6     movw  ya,$f6
10a3: 8f 7f f4  mov   $f4,#$7f
10a6: 1a df     decw  $df
10a8: f0 1d     beq   $10c7
10aa: 3a dd     incw  $dd
10ac: c7 dd     mov   ($dd+x),a
10ae: 1a df     decw  $df
10b0: f0 15     beq   $10c7
10b2: 3a dd     incw  $dd
10b4: dd        mov   a,y
10b5: c7 dd     mov   ($dd+x),a
10b7: 3a dd     incw  $dd
10b9: 1a df     decw  $df
10bb: f0 0a     beq   $10c7
10bd: 13 9f b5  bbc0  $9f,$1075
...
; vcmd dispatch table
116d: dw $0ac7  ; d4
116f: dw $0b3e  ; d5 - (unconditional) loop point
1171: dw $0b4a  ; d6 - (unconditional) loop
1173: dw $0b54  ; d7 - (related to contidional jump?)
1175: dw $0ba6  ; d8 - (contidional jump?)
1177: dw $0b6b  ; d9 - (contidional jump?)
1179: dw $0e46  ; da - push address
117b: dw $0e63  ; db - pop address
117d: dw $0b32  ; dc
117f: dw $0941  ; dd - instrument
1181: dw $0860  ; de
1183: dw $0aa8  ; df
1185: dw $098b  ; e0
1187: dw $0992  ; e1
...
11b7: dw $09bb  ; f9
11b9: dw $09e6  ; fa
11bb: dw $0000  ; fb - (undefined)
11bd: dw $0000  ; fc - (undefined)
11bf: dw $0000  ; fd - (undefined)
11c1: dw $0000  ; fe - (undefined)
11c3: dw $0ad9  ; ff
