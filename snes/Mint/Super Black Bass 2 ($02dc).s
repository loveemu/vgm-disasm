...
038a: fa 13 f3  mov   ($f3),($13)
038d: cd 00     mov   x,#$00
038f: 8f 01 11  mov   $11,#$01
0392: 3f d7 05  call  $05d7
0395: 3d        inc   x
0396: 0b 11     asl   $11
0398: d0 f8     bne   $0392
039a: e4 1a     mov   a,$1a
...
03aa: fa 15 f3  mov   ($f3),($15)
03ad: 8f 3d f2  mov   $f2,#$3d
03b0: fa 14 f3  mov   ($f3),($14)
03b3: 8f 6c f2  mov   $f2,#$6c
03b6: fa 17 f3  mov   ($f3),($17)
03b9: e4 12     mov   a,$12
03bb: 44 13     eor   a,$13
03bd: 24 13     and   a,$13
...
03cb: fa 16 f3  mov   ($f3),($16)
03ce: 8f 0d f2  mov   $f2,#$0d
03d1: fa 18 f3  mov   ($f3),($18)
03d4: 8f 4c f2  mov   $f2,#$4c
03d7: fa 12 f3  mov   ($f3),($12)
03da: e8 00     mov   a,#$00
03dc: c4 12     mov   $12,a
03de: c4 13     mov   $13,a
03e0: 6f        ret
...
0401: 30 1d     bmi   $0420
0403: f0 03     beq   $0408
0405: d5 a2 02  mov   $02a2+x,a
0408: 3f 61 04  call  $0461
040b: fc        inc   y
040c: f7 2d     mov   a,($2d)+y
040e: 30 0e     bmi   $041e
0410: d5 2c 02  mov   $022c+x,a
0413: fc        inc   y
0414: f7 2d     mov   a,($2d)+y
0416: 30 06     bmi   $041e
0418: d5 d3 00  mov   $00d3+x,a
041b: fc        inc   y
041c: f7 2d     mov   a,($2d)+y
041e: 2f 08     bra   $0428
0420: 2d        push  a
0421: f5 a2 02  mov   a,$02a2+x
0424: 3f 61 04  call  $0461
0427: ae        pop   a
0428: fc        inc   y
0429: 68 c0     cmp   a,#$c0
042b: b0 1c     bcs   $0449
...
0434: 10 07     bpl   $043d
0436: 28 7f     and   a,#$7f
0438: d5 d3 00  mov   $00d3+x,a
043b: 2f 03     bra   $0440
043d: d5 2c 02  mov   $022c+x,a
0440: fc        inc   y
0441: ae        pop   a
0442: 28 1f     and   a,#$1f
...
044e: ae        pop   a
044f: 3f 90 06  call  $0690
0452: f4 7b     mov   a,$7b+x
0454: f0 a9     beq   $03ff
0456: dd        mov   a,y
0457: 8d 00     mov   y,#$00
0459: 7a 2d     addw  ya,$2d
045b: d4 45     mov   $45+x,a
045d: dd        mov   a,y
045e: d4 57     mov   $57+x,a
0460: 6f        ret
...
04a3: e4 33     mov   a,$33
04a5: 60        clrc
04a6: 95 6c 02  adc   a,$026c+x
04a9: 60        clrc
04aa: 95 5a 02  adc   a,$025a+x
04ad: 28 7f     and   a,#$7f
04af: c4 33     mov   $33,a
04b1: 3f 58 05  call  $0558
04b4: b0 73     bcs   $0529
04b6: 3f 49 0d  call  $0d49
04b9: 68 00     cmp   a,#$00
04bb: f0 1d     beq   $04da
04bd: c4 38     mov   $38,a
04bf: cc 37 00  mov   $0037,y
04c2: e4 06     mov   a,$06
04c4: 2d        push  a
04c5: 8f 00 06  mov   $06,#$00
04c8: 7d        mov   a,x
04c9: 3f 32 0d  call  $0d32
04cc: ae        pop   a
04cd: c4 06     mov   $06,a
04cf: b0 09     bcs   $04da
04d1: e4 38     mov   a,$38
...
04dc: d6 cb 00  mov   $00cb+y,a
04df: 7d        mov   a,x
04e0: d6 1c 02  mov   $021c+y,a
04e3: e8 00     mov   a,#$00
04e5: d6 24 02  mov   $0224+y,a
04e8: 3f 38 05  call  $0538
04eb: e4 06     mov   a,$06
04ed: d6 4f 00  mov   $004f+y,a
04f0: e4 07     mov   a,$07
04f2: d6 61 00  mov   $0061+y,a
04f5: f5 7e 02  mov   a,$027e+x
04f8: d6 88 02  mov   $0288+y,a
04fb: e4 33     mov   a,$33
04fd: d6 64 02  mov   $0264+y,a
0500: d6 76 02  mov   $0276+y,a
0503: f5 d3 00  mov   a,$00d3+x
0506: d6 dd 00  mov   $00dd+y,a
0509: f4 8d     mov   a,$8d+x
050b: 28 04     and   a,#$04
050d: d6 97 00  mov   $0097+y,a
0510: 3f 4b 05  call  $054b
0513: f6 c5 01  mov   a,$01c5+y
0516: 48 ff     eor   a,#$ff
0518: 24 16     and   a,$16
051a: c4 16     mov   $16,a
...
0525: 04 16     or    a,$16
0527: c4 16     mov   $16,a
0529: f5 2c 02  mov   a,$022c+x
052c: f0 05     beq   $0533
052e: 13 44 01  bbc0  $44,$0532
0531: 5c        lsr   a
0532: bc        inc   a
0533: d6 b1 00  mov   $00b1+y,a
0536: ee        pop   y
0537: 6f        ret
0538: f5 00 02  mov   a,$0200+x
053b: 10 0a     bpl   $0547
053d: 4d        push  x
053e: e4 0a     mov   a,$0a
0540: 28 0f     and   a,#$0f
...
05b6: c4 2e     mov   $2e,a
05b8: 8d 00     mov   y,#$00
05ba: f7 2d     mov   a,($2d)+y
05bc: 30 05     bmi   $05c3
05be: d4 7b     mov   $7b+x,a
05c0: fc        inc   y
05c1: 2f 08     bra   $05cb
05c3: fc        inc   y
05c4: 3f 90 06  call  $0690
...
05f2: f5 88 02  mov   a,$0288+x
05f5: c4 31     mov   $31,a
05f7: f5 76 02  mov   a,$0276+x
05fa: c4 32     mov   $32,a
...
062b: fd        mov   y,a
062c: f5 88 02  mov   a,$0288+x
062f: 60        clrc
0630: 96 b6 02  adc   a,$02b6+y
0633: c4 31     mov   $31,a
0635: f5 76 02  mov   a,$0276+x
0638: 96 c0 02  adc   a,$02c0+y
063b: c4 32     mov   $32,a
063d: 3f 4e 0f  call  $0f4e
0640: 33 34 1a  bbc1  $34,$065d
0643: f5 1c 02  mov   a,$021c+x
0646: fd        mov   y,a
0647: f6 90 02  mov   a,$0290+y
064a: fd        mov   y,a
064b: f5 9a 02  mov   a,$029a+x
064e: cf        mul   ya
064f: f5 dd 00  mov   a,$00dd+x
0652: 1c        asl   a
0653: cf        mul   ya
0654: e4 1f     mov   a,$1f
0656: 1c        asl   a
...
069f: eb 02     mov   y,$02
06a1: 6f        ret
06a2: f7 06     mov   a,($06)+y
06a4: 28 07     and   a,#$07
06a6: 3f 07 47  call  $4707
06a9: 07 56     or    a,($56+x)
06ab: 07 82     or    a,($82+x)
06ad: 07 50     or    a,($50+x)
06af: 07 ba     or    a,($ba+x)
06b1: 08 97     or    a,#$97
06b3: 07 9e     or    a,($9e+x)
06b5: 07 a5     or    a,($a5+x)
06b7: 07 c0     or    a,($c0+x)
06b9: 07 db     or    a,($db+x)
06bb: 07 07     or    a,($07+x)
06bd: 08 1a     or    a,#$1a
06bf: 08 40     or    a,#$40
06c1: 08 69     or    a,#$69
06c3: 08 5d     or    a,#$5d
06c5: 07 64     or    a,($64+x)
06c7: 07 6e     or    a,($6e+x)
06c9: 07 f0     or    a,($f0+x)
06cb: 06        or    a,(x)
06cc: 77 08     cmp   a,($08)+y
06ce: 85 08 04  adc   a,$0408
06d1: 09 ec 08  or    ($08),($ec)
06d4: c1        tcall 12
06d5: 08 90     or    a,#$90
06d7: 08 8c     or    a,#$8c
06d9: 08 86     or    a,#$86
06db: 07 94     or    a,($94+x)
06dd: 08 11     or    a,#$11
06df: 09 3d 09  or    ($09),($3d)
06e2: 4b 09     lsr   $09
06e4: 4f 09     pcall $09
06e6: f4 08     mov   a,$08+x
06e8: 78 07 2c  cmp   $2c,#$07
06eb: 07 5e     or    a,($5e+x)
06ed: 09 6d 09  or    ($09),($6d)
...
09fa: 2d        push  a
09fb: 6f        ret
09fc: 93 0a 9a  bbc4  $0a,$0999
09ff: 0a a9 0a  or1   c,$0aa9,0
0a02: b2 0a     clr5  $0a
0a04: bf        mov   a,(x)+
0a05: 0a 5c 0a  or1   c,$0a5c,0
0a08: 60        clrc
0a09: 0a 3c 0a  or1   c,$0a3c,0
0a0c: 47 0a     eor   a,($0a+x)
0a0e: 40        setp
0a0f: 0a fb 09  or1   c,$09fb,0
0a12: fb 09     mov   y,$09+x
0a14: fb 09     mov   y,$09+x
0a16: fb 09     mov   y,$09+x
0a18: fb 09     mov   y,$09+x
0a1a: fb 09     mov   y,$09+x
0a1c: 39        and   (x),(y)
0a1d: 0b 53     asl   $53
0a1f: 0b 07     asl   $07
0a21: 0c 75 0b  asl   $0b75
0a24: 8d 0b     mov   y,#$0b
0a26: af        mov   (x)+,a
0a27: 0b 6d     asl   $6d
0a29: 0b 71     asl   $71
...
0a2d: 0d        push  psw
0a2e: 20        clrp
0a2f: 0c 81 0b  asl   $0b81
0a32: 9e        div   ya,x
0a33: 0b bb     asl   $bb
0a35: 0b e1     asl   $e1
0a37: 0b 0f     asl   $0f
0a39: 0b fb     asl   $fb
0a3b: 09 fa 3b  or    ($3b),($fa)
0a3e: 41        tcall 4
0a3f: 6f        ret
